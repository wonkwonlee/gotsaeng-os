...
/**
 * `node:fs`-backed FileSystemAdapter for the MCP server. Duplicated from
 * packages/cli/src/node-file-system.ts rather than shared: packages/core
 * never imports node:fs itself, and this package has no reason to depend on
 * @gotsaeng/cli just to borrow this much fs wrapping.
 */
