...
- Implement the Markdown scanner and parser. (source: 01_projects/gotsaeng-os.md; status: done; tags: context-engineering, llm, open-source)
- Write the first README quickstart. (source: 03_logs/weekly-review-2026-W23.md; status: done; tags: stale-demo, weekly-review)
